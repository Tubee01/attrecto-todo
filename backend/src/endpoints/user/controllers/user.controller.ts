import { Body, Controller, Delete, Get, HttpException, HttpStatus, Param, ParseUUIDPipe, Post, Put, Query, Res, UploadedFile, UploadedFiles, UseInterceptors } from '@nestjs/common';
...
export class UserController {
    ...
    async processImage(
        ...
        if (files.length > 1) {
            throw new HttpException('Only one file can be uploaded', HttpStatus.BAD_REQUEST);
        }
        try {
