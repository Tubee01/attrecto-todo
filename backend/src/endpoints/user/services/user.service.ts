...
export class UserService {
    ...
    async findByUnique(value: string, unique: string = 'id'): Promise<User> {
    ...
    async update(id: string, args: CreateUserDTO): Promise<User> {
        ...
        const queryArgs = buildUpdateQuery('User', { name, email, password: hashedPassword, admin }, id);
